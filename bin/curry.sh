...
./word2vec -train ~/www/curry/bin/curry_wakati_replace.txt -output ~/www/curry/bin/curry.bin -cbow 0 -size 200 -window 5 -negative 0 -hs 1 -sample 1e-3 -threads 12 -binary 1
